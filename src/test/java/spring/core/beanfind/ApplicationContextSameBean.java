...
public class ApplicationContextSameBean {
    ...
    //static 사용이유 = 테스트 클래스이므로 ApplicationContextSameBean 클래스안에서만 사용하겠다
    @Configuration
    ...
    //SameBeanConfig 에 선언된 빈들의 타입이 동일하여 테스트 실패
//    @Test
//    @DisplayName("타입으로 조쇠 시 같은 타입이 둘 이상 있으면, 중복 오류가 발생한다.")
